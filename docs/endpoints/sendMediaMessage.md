...
| `fileUrl` | string (uri) | yes | Public HTTPS URL of the document. Must be publicly reachable: hosts that resolve to private, loopback, link-local or metadata addresses are refused with 422 (`The URL must be a public http(s) address.`). |
